...
```{r reading DE gene list for CHMI cohort, eval=FALSE, warning=FALSE}
...
# only 50 genes... 
intersect(colnames(dfsub_16), merged_genes) #but it is subsetting right... 
#intersect(colnames(dfsub_16), genes)
...
```{r Figure5D, warning=FALSE, include=FALSE, echo=TRUE, fig.height=10, fig.width=6}
Heatmap(t(dfsub_16),
